 ...
 function TickPositioner() {
            ...
            return function(min, max) {
                ...
                if (!multiple || !_self.zero_align) {
                    ...
                    if (!_self.maxminLookup) {
                        ...
                        for (var j in _self.maxmin) {
                            _self.maxminLookup[_self.maxmin[j].id] = _self.maxmin[j];
                        }
                    ...
                    // ['-+-+', '-+++', '-+0+', '++-+', '0+-+']
                        ...
                        idx = (_self.maxmin[0].min <= _self.maxmin[1].min) ? 0 : 1;
                        f = _self.maxmin[idx].min / _self.maxmin[idx].max;
                    ...
                    // ['-+--','-+-0',  '---+', '-0-+']
                        ...
                        idx = (_self.maxmin[0].max > _self.maxmin[1].max) ? 0 : 1;
                        f = _self.maxmin[idx].max / _self.maxmin[idx].min;
    ...
    function createArrayFromRange(start, end, n) {
        ...
        while (true) {
            ...
            if (value > start) {
                result.push(correctFloat(value));
            } else {
                if (start < 0) {
                    result.push(correctFloat(value));
                }
